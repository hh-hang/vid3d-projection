<template>
    ...
    <a
        class="source"
        href="https://github.com/hh-hang/vid3d-projection/blob/main/example/src/three-cinema.vue"
        target="_blank"
        rel="noopener noreferrer"
    >
        ...
        .then((gltf) => {
            ...
            model.traverse((child: any) => {
                if (child.isMesh) {
                    ...
                    ThreeProjectorTool.addTargetMesh(child);
                }
            });
            scene.add(model);
        });
